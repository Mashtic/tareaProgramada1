...
# Ejemplo entrada
visitantes = [[305430092, ("Ian", "Coto", "Soto"), ["I1642", "A1933"], [("La venganza","13/02/2022","Muy lejos", "Uno bonito", "https://www.google.com")], False], [987654321, ("Pedro", "Moto", "Zote"), ["A1933", "V1928"], [("La venganza","14/02/2022","Muy lejos", "Uno bonito", "https://www.google.com")], True], 
...
def estadisticasAstros(pVisitantes, pContAstros):
    for astronomo in pContAstros:
        for visitante in pVisitantes:
...
def reporteStatsAstros(pVisitantes, pAstronomos):
    ...
    statsAstros = estadisticasAstros(pVisitantes, contAstros)
    for astronomo in statsAstros:
        strElementos = ("<tr><td>"+pAstronomos[astronomo[0]][0]+"</td><td>"+ str(astronomo[1])+"</td></tr>")
        strTabla += strElementos
    strTabla += "</table></html>"
    return crearArchivoHtml("Estadísticas astronónomos", strTabla)
...
#print(estadisticasAstros(visitantes, contAstros))
